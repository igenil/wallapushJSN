        ...
        <table class="table">
            ...
            <tbody>
                @foreach($trans as $tran)
                    ...
                    <td><a class="btn btn-outline-warning" data-toggle="modal" data-target="#ValorarModal{{$tran->id}}"><i class="far fa-star"></i> Valorar</a></td> 
                        @else
                    ...
                    <div class="modal fade" id="ValorarModal{{$tran->id}}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body">
                                    <center>
                                        <div role="alert">
                                        <form method="POST" action="addValoracion/{{$tran->id}}">
                                                {{ csrf_field() }}
                                                <div>
                                                ...
                                                <br>
                                                <br>
                                                <button type="submit" name="addValoracion" class="btn btn-warning">{{ __("Valorar") }}</button> &nbsp;           
